...
### API 26 Beta1 变更（2026-06-12，HDC 版本发布）

- **新增 14 篇文档**：通用设计基础（鸿蒙黑体、沉浸光感、圆角参数、间隔参数）、控件（色彩选择器）、系统特性（闪控球和闪控窗、桌面快捷方式、平行视界）、智能座舱系列 6 篇（概述、基础体验要求、设计基础、系统架构、应用架构、HUAWEI HiCar）
- **"字体排印"更名为"文本排印"**
- **多个控件新增沉浸光感内容**：底部页签、子页签、标题栏、导航点、索引条、即时反馈、即时操作、气泡提示、按钮、下拉按钮、状态按钮、操作块、工具栏、核心操作栏、菜单、文本选择菜单、搜索框、开关、滑动条、分段按钮、弹出框、半模态面板等
- **手势规范新增隔空手势内容**
- **UX 体验标准更新**：通用应用、大屏应用、折叠屏应用均新增多条体验标准

### API 24 Release 变更（2026-05-26）

- 应用接入状态栏（原"应用状态栏接入"更名）
- 实况窗：添加卡片视觉重心说明文字

### 其他阶段性变更

- 2026-05-18：靠近发现新增交互规则、附加元素规则、标题栏规范
- 2026-05-13：阔折叠新增滑动沉浸内容
- 2026-04-28：窗口框架新增"窗口回弹规格"、"窗口分屏准入原则"
- 2026-04-01：播控中心图文更新
- 2026-03-30：新增"智感握姿"文档

> 详细变更内容请参见 [设计变更](references/design-changes.md)。
