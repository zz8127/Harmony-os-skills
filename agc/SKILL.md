...
- [分析服务](references/analytics.md) — 应用分析报表/元服务分析/行业风向标
...
| | 分析服务 | 用户行为/事件/漏斗分析 |
| | 行业风向标 | 应用和游戏两大行业的数据指标和用户画像 |
| **质量** | 崩溃服务 | 崩溃采集/分析/告警 |
| | 性能服务 | ANR/慢操作/网络性能/可视化实时报告 |
| | 云监控 | 应用运行状态实时监控 |
| **变现** | 应用内支付 | IAP 消耗型/非消耗型/订阅 |
| | 广告服务 | Ads Kit 广告变现 |
| | 华为支付 | Payment Kit：便捷安全的支付方式 |
| | 钱包服务 | Wallet Kit：车钥匙/交通卡 |
| | 应用市场服务 | AppGallery Kit：数字商品/推荐/归因/评论 |
| | 付费下载 | 应用付费下载 |
| | 联运服务 | 华为渠道联运 |
| **构建** | Connect API | 流程自动化 RESTful API |
| | 联机对战 | 多人联机房间/匹配/消息通信 |
| | 游戏多媒体 | 实时语音/信令/语音消息 |
